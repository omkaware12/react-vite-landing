...
const MedicinesPage = () => (
  <div>
    ...
    <div className="space-y-4 max-w-3xl">
      <DashboardActionCard icon={Plus} title="Create Medicine" description="Add a single medicine" />
      <DashboardActionCard icon={Layers} title="Create Medicine in Bulk" description="Add medicines in bulk" />
      <DashboardActionCard icon={List} title="Get All Medicines" description="View all medicines" />
    </div>
  </div>
);
