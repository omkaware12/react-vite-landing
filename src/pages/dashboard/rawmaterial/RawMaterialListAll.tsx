...
const RawMaterialListAll = () => {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-4">All Transaction Materials</h1>
      <div className="bg-white rounded-xl shadow-sm border overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {pageItems.map((r, i) => (
              <tr key={r.id} className={i % 2 === 0 ? "bg-[hsl(174,40%,97%)]" : "bg-white"}>
            ...
            {items.length === 0 && (
              <tr><td colSpan={4} className="px-6 py-8 text-center text-gray-400">No raw materials yet</td></tr>
            )}
          </tbody>
        </table>
      </div>
